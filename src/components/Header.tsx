          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                {/* Secret Trigger Button / Discrete Admin Entry */}
                <button
                  onClick={isAdminMode ? onOpenAdminPanel : onOpenAdminModal}
                  className="text-xs px-2 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 font-medium border border-indigo-500/30 hover:bg-indigo-500/40 hover:text-white transition cursor-pointer flex items-center space-x-1"
                  title="관리자 설정"
                >
                  <span>v2.0 스마트</span>
